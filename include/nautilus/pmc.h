...
/* Haswell-specific */
#define INTEL_HASWELL_DTLB_LOAD_MISS_WALK  0x07
#define INTEL_HASWELL_DTLB_LOAD_MISS_STLB_HIT  0x08

/* SKYLAKE-specific */
#define INTEL_SKYLAKE_DTLB_LOAD_MISS_WALK  0x07
#define INTEL_SKYLAKE_DTLB_LOAD_MISS_STLB_HIT  0x09
